...
public class FavoriteAdapter extends RecyclerView.Adapter<FavoriteAdapter.FAvoritesAdapterViewHolder> {

    /* List for all movies*/
    private List<FavoriteEntry> FavoritessList;
    ...
    public FavoriteAdapter(MovieAdapterOnClickHandler clickHandler, List<Movies> moviesList) {
